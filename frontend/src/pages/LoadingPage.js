    ...
    return (
      <Layout>
        <div className="flex justify-center items-center h-screen">
          ...
          >
            <motion.div
              className="w-6 h-6 bg-purple-500 rounded-full dark:bg-purple-300"
              animate={{
                scale: [1, 1.5, 1],
                opacity: [0.7, 1, 0.7],
              }}
          ...
          <p className="mt-4 text-lg sm:text-xl font-semibold dark:text-white ml-4">Loading analysis...</p>
        </div>
      </Layout>
    );
  }
