...
import { List, CheckCircle, HelpCircle, FileText, Loader } from 'lucide-react';
    ...
    <Layout>
      ...
      >
        <div className="flex items-center justify-center mb-6">
          <FileText className="text-purple-500 dark:text-purple-300 mr-2" size={28} />
          <h2 className="text-2xl sm:text-3xl font-bold text-center text-gray-800 dark:text-white">Resume Based Questions</h2>
        </div>
